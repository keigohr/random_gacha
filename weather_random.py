...
def return_weather():
  ...
  for index in index_list:
    ...
    weathers1.append(sg.Image(weather_image, background_color='LightGreen4'))
    rain_number+=index

  index_list = random.choices(index_choice, weights=(100-value, value), k=5)
  for index in index_list:
    weather_image=weather_image_list[index]
    weathers2.append(sg.Image(weather_image, background_color='LightGreen4'))
    rain_number+=index
  ...
  layout_column=[[sg.Text(content0, font = (myfont, 20), background_color='LightGreen4')], [sg.Text(content1,font = (myfont, 20), background_color='LightGreen4')], weathers1, weathers2, [sg.Text(content2,font = (myfont, 20), background_color='LightGreen4')]]
  layout = [[sg.Column(layout_column, element_justification='center', background_color='LightGreen4')]]
